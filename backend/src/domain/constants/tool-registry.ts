...
export type ToolArgConstraints = Readonly<
  Record<string, Readonly<Record<string, ArgConstraint>>>
>;
...
export const TOOL_REGISTRY: Record<string, ToolMetadata> = {
  ...
  list_bundles: {
    ...
    suggestions: [
      "Show my balance",
      "Check my usage",
      "View Value Plus details",
    ],
    description:
      "List available bundles, plans, packages, or offers. Use when the user asks about available plans or wants to compare packages.",
    parameters: {
      type: "object",
      properties: {
        userId: { type: "string", description: "The user ID" },
    ...
    parameters: {
      ...
      properties: {
        ...
        bundleId: {
          type: "string",
          description:
            "The bundle ID to view details for. Must be one of: b1, b2, b3, b4, b5",
        },
      },
  ...
  purchase_bundle: {
    ...
    description:
      "Purchase or activate a specific bundle for the user. ONLY use this tool AFTER the user has viewed bundle details and explicitly confirmed they want to purchase. Do NOT use this for initial purchase requests - use view_bundle_details first. Available bundle IDs: b1 (Starter Pack), b2 (Value Plus), b3 (Unlimited Pro), b4 (Weekend Pass), b5 (Travel Roaming).",
    parameters: {
      type: "object",
      properties: {
        userId: { type: "string", description: "The user ID" },
        bundleId: {
          type: "string",
          description:
            "The bundle ID to purchase. Must be one of: b1, b2, b3, b4, b5",
        },
      },
      required: ["userId", "bundleId"],
    },
  ...
  top_up: {
    ...
    parameters: {
      ...
      properties: {
        ...
        amount: {
          type: "string",
          description: 'The amount to top up (e.g. "20", "50")',
        },
      },
  ...
  get_account_summary: {
    ...
    description:
      'Get a comprehensive account overview including profile, active subscriptions, recent transactions, and open tickets. Use when the user asks for "my account", "account overview", "my dashboard", "my profile", or wants a summary of everything.',
    parameters: {
      type: "object",
      properties: {
        userId: { type: "string", description: "The user ID" },
